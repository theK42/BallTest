...
public:
	BallLuaBinding(void);
	~BallLuaBinding(void);
	void Init(lua_State * luaState, KEngine2D::MechanicsUpdater * mechanicsSystem, KEngine2D::PhysicsSystem * physicsSystem, KEngine2D::HierarchyUpdater * hierarchySystem, KEngineWindows::ConsoleRenderer * renderer);
	void Deinit();
...
private:
	...
	KEngineWindows::ConsoleRenderer *	mRenderer;
