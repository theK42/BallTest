...
void BallLuaBinding::Init(lua_State * luaState, KEngine2D::MechanicsUpdater * mechanicsSystem, KEngine2D::PhysicsSystem * physicsSystem, KEngine2D::HierarchyUpdater * hierarchySystem, KEngineWindows::ConsoleRenderer * renderer) {
...
SimpleBall * BallLuaBinding::NewBall(KEngine2D::Point & position, KEngine2D::Point & velocity, double radius, double mass) {
	...
	ball->Init(mMechanicsSystem, mPhysicsSystem, mHierarchySystem, mRenderer, position, velocity, radius, mass);
	return ball;
}