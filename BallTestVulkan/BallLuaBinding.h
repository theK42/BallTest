...
public:
	BallLuaBinding(void);
	~BallLuaBinding(void);
	void Init(lua_State * luaState, KEngineBox2D::Box2DWorld * boxWorld, KEngine2D::HierarchyUpdater * hierarchySystem, KEngineVulkan::SpriteRenderer * renderer, SpriteFactory * spriteFactory);
	void Deinit();
...
private:
	...
	KEngineVulkan::SpriteRenderer *		mRenderer;
